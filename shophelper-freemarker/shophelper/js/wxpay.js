(function(_TApi)
{
	...
	VNavigatorBar.updateNavTitle("${languageMap.WxPay}");
...
//    	return; 
        ...
        }, function(success, responseObj)
        {
            ...
            {
            	_TApi.prompt('${languageMap.TradeState}: ${languageMap.Refund}', function(){});
            }
            ...
            {
            	_TApi.prompt('${languageMap.TradeState}: ${languageMap.Revoked}', function(){});
            }
            else if(responseObj.Header.Alert == "USERPAYING") //用户支付中
            {
            	_TApi.prompt('${languageMap.TradeState}: ${languageMap.UserPaying}', function(){});
            }
            else if(responseObj.Header.Alert == "PAYERROR") //支付失败(其他原因，如银行返回失败)
            {
            	_TApi.prompt('${languageMap.TradeState}: ${languageMap.PayError}', function(){});
            }
