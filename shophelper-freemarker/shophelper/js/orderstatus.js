window.TApi.orderstatus = (function(_TApi)
{
	...
	function initTable()
	{
		var _newDate = new Date(),
			_week = ['${languageMap.Sun}', '${languageMap.Mon}', '${languageMap.Tue}', '${languageMap.Wed}', '${languageMap.Thu}', '${languageMap.Fri}', '${languageMap.Sat}'],
		...
		if(_secNum) 
		{
			...
			_secTime.innerHTML ='${languageMap.Expected} '+ _secData.getElementsByTagName('ul')[_posArr[1]].firstChild.innerText +' '+ _time[_posArr[0]] + ' ${languageMap.arrived}';
		...
		else
		{
			...
			_secTime.innerHTML ='${languageMap.Expected} '+ _TApi.$cls('yes', _secData)[0].parentNode.firstChild.innerText +' '+ _time[_count < 3 ? _count : 0] + ' ${languageMap.arrived}';
		}
	...
	for(var i = 0, num = _secLiYes.length; i < num; i++)
	{
		_secLiYes[i].onclick =  function()
		{
			...
			_secTime.innerHTML = '${languageMap.Expected} '+ this.parentNode.firstChild.innerText +' '+ _time[this.getAttribute('row')] + ' ${languageMap.arrived}';
