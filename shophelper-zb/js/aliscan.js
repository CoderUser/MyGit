...
{
	var 
		_aliScanResult = _TApi.$id("ali-scan-result"),
		_aliscanButton = _TApi.$id("ali-scan-btn"),
	...
	VNavigatorBar.updateNavTitle("${languageMap.AliScan}");
...
//			TotalFee: 1, //test
	...
	_aliscanButton.onclick = function()
	{
		_scanQrcode();
	};
